        ...
        >
          {facilities.map((item) => (
            ...
            >
              ...
              <div className="relative bg-secondary-bg px-5 py-4.5 flex-1 flex flex-col justify-center border-l-2 border-primary border-b border-primary/60 group-hover:bg-primary group-hover:border-l-4 group-hover:border-l-white group-hover:border-b-primary transition-all duration-300">
